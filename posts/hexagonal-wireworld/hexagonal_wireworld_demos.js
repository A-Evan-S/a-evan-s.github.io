...
const golButton3 = document.getElementById("gol-mwss");
const golButton4 = document.getElementById("gol-glider-gun");
const golButton5 = document.getElementById("gol-clear");
golButton1.addEventListener('click', fillRandomGOL);
golButton2.addEventListener('click', fillGliderGOL);
golButton3.addEventListener('click', fillMWSSGOL);
golButton4.addEventListener('click', fillGliderGunGOL);
golButton5.addEventListener('click', clearGOL);
...
function fillGliderGOL() {
    let state = demos['GOL'].state;
    state.grid = Array.from({ length: state.numRows }, () => new Array(state.numCols).fill('dead'));
    [[14, 19], [14, 20], [14, 21], [13, 21], [12, 20]].forEach((pos) => state.grid[pos[0]][pos[1]] = 'alive');
    demos['GOL'].drawFunc(state, demos['GOL'].ctx);
}

function fillMWSSGOL() {
    let state = demos['GOL'].state;
    state.grid = Array.from({ length: state.numRows }, () => new Array(state.numCols).fill('dead'));
    [
        [16, 18], [14, 19], [15, 19], [15, 20], [16, 20], [16, 26], [15, 26], [14, 26], [14, 27], [15, 28], [9, 29], [10, 29], [11, 29], [11, 30], [10, 31]
    ].forEach((pos) => state.grid[pos[0]][pos[1]] = 'alive');
    demos['GOL'].drawFunc(state, demos['GOL'].ctx);
}

function fillGliderGunGOL() {
    let state = demos['GOL'].state;
    state.grid = Array.from({ length: state.numRows }, () => new Array(state.numCols).fill('dead'));
    [
        [8, 2], [8, 3], [9, 2], [9, 3], [6, 14], [6, 15], [7, 13], [7, 17], [8, 12], [8, 18], [9, 12], [9, 16], [9, 18], [9, 19], [10, 12], [10, 18], [11, 13], [11, 17], [12, 14], [12, 15], [4, 26], [5, 24], [5, 26], [6, 22], [6, 23], [7, 22], [7, 23], [8, 22], [8, 23], [9, 24], [9, 26], [10, 26], [6, 36], [6, 37], [7, 36], [7, 37]
    ].forEach((pos) => state.grid[pos[0]][pos[1]] = 'alive');
    demos['GOL'].drawFunc(state, demos['GOL'].ctx);
}
...
const wwButton5 = document.getElementById("ww-clear");
...
wwButton5.addEventListener('click', clearWW);
...
function fillORWW() {
    ...
    [
        [8, 6], [7, 7], [9, 7], [7, 8], [9, 8], [7, 9], [9, 9], [8, 10], [8, 11], [12, 2], [11, 3], [13, 3], [11, 4], [13, 4],
[11, 5], [13, 5], [11, 6], [13, 6], [11, 7], [13, 7], [11, 8], [13, 8], [11, 9], [13, 9], [12, 10], [12, 11], [8, 12], [12, 12], [8, 13], [12, 13], [8, 14], [12, 14], [8, 15], [12, 15], [10, 15], [9, 16], [11, 16], [10, 16], [10, 17], [10, 18], [10, 19], [10, 20], [10, 21], [10, 22], [10, 23], [10, 24]
    ].forEach((pos) => state.grid[pos[0]][pos[1]] = 'conductor');
    state.grid[9][9] = 'e-head';
    state.grid[9][8] = 'e-tail';
    state.grid[13][9] = 'e-head';
    state.grid[13][8] = 'e-tail';
    demos['WW'].drawFunc(state, demos['WW'].ctx);
}
...
function fillXORWW() {
    ...
    [
        [7, 6], [6, 7], [8, 7], [6, 8], [8, 8], [6, 9], [8, 9], [7, 10], [7, 11],
        [13, 2], [12, 3], [14, 3], [12, 4], [14, 4], [12, 5], [14, 5], [12, 6], [14, 6], [12, 7], [14, 7], [12, 8], [14, 8], [12, 9], [14, 9], [13, 10], [13, 11],
    ].forEach((pos) => state.grid[pos[0]][pos[1]] = 'conductor');
    state.grid[4][25] = 'e-head';
...
function fillFlipFlopHex() {
    ...
    [
        [4, 9], [4, 10], [4, 11], [4, 12], [4, 13], [4, 14], [4, 15], [4, 16], [4, 17], [4, 18], [4, 19], [3, 20], [2, 19], [5, 20], [6, 19], [5, 17], [6, 16], [8, 15], [8, 16], [8, 19], [8, 20], [9, 16], [9, 20], [10, 15], [10, 19], [11, 15], [11, 19], [12, 7], [12, 8], [12, 9], [12, 10], [12, 11], [12, 12], [12, 13], [12, 14], [12, 15], [12, 16], [12, 17], [12, 18], [12, 19], [12, 20], [12, 21], [12, 22], [12, 23], [12, 24], [12, 25], [12, 26], [13, 7], [13, 27], [14, 6], [14, 9], [14, 10], [14, 11], [14, 12], [14, 13], [14, 14], [14, 15], [14, 16], [14, 17], [14, 18], [14, 19], [14, 20], [14, 21], [14, 22], [14, 23], [14, 24], [14, 25], [14, 26], [15, 7], [15, 9], [16, 6], [16, 9], [16, 10], [16, 11], [16, 12], [16, 13], [16, 14], [16, 15], [16, 16], [16, 17], [16, 18], [16, 19], [16, 20], [16, 21], [16, 22], [16, 23], [16, 24], [16, 25], [16, 26], [17, 7], [17, 27], [18, 6], [18, 9], [18, 10], [18, 11], [18, 12], [18, 13], [18, 14], [18, 15], [18, 16], [18, 17], [18, 18], [18, 19], [18, 20], [18, 21], [18, 22], [18, 23], [18, 24], [18, 25], [18, 26], [19, 7], [19, 9], [20, 6], [20, 9], [20, 10], [20, 11], [20, 12], [20, 13], [20, 14], [20, 15], [20, 16], [20, 17], [20, 18], [20, 19], [20, 20], [20, 21], [20, 22], [20, 23], [20, 24], [20, 25], [20, 26], [21, 7], [21, 27], [22, 7], [22, 8], [22, 9], [22, 10], [22, 11], [22, 12], [22, 13], [22, 14], [22, 15], [22, 16], [22, 17], [22, 18], [22, 19], [22, 20], [22, 21], [22, 22], [22, 23], [22, 24], [22, 25], [22, 26]

    ].forEach((pos) => state.grid[pos[0]][pos[1]] = 'conductor');
    state.grid[12][9] = 'e-head';
    state.grid[12][8] = 'e-mid';
    state.grid[12][7] = 'e-tail';
...
function fillFlashersHex() {
    ...
    [
        [9, 8], [9, 10], [10, 8], [10, 9], [10, 6], [10, 11], [11, 7], [11, 11], [12, 5], [12, 6], [12, 11], [12, 12], [14, 5], [14, 6], [14, 11], [14, 12], [15, 7], [15, 11], [16, 6], [16, 11], [16, 8], [16, 9], [17, 8], [17, 10]
    ].forEach((pos) => state.grid[pos[0]][pos[1]] = 'conductor');
    state.grid[9][8] = 'e-head';
    state.grid[10][8] = 'e-head';
    state.grid[9][10] = 'e-mid';
    state.grid[10][9] = 'e-mid';

    state.grid[14][11] = 'e-head';
    state.grid[14][12] = 'e-head';
    state.grid[15][11] = 'e-mid';
    state.grid[16][11] = 'e-mid';

    state.grid[15][7] = 'e-head';
    state.grid[16][6] = 'e-head';
    state.grid[14][5] = 'e-mid';
    state.grid[14][6] = 'e-mid';
