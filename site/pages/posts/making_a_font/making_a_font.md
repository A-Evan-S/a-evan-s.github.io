...
<div style='text-align: center; margin-bottom: -25px;'>
  <p style='font-family: "sans_sands_sans"; font-size:1.9em'>
      This is my font.<br>
...
![Example of FontForge's named guide tools](font_5.png){: style="max-width: 400px"}
...
![FontForge's default view of all the characters in the encoding](font_1.png){: style="max-width: 500px"}
...
![A very poor attempt to freehand draw the letter 'A'](font_2.png){: style="max-width: 400px"}
...
![A corrected version of the letter 'A'](font_3.png){: style="max-width: 400px"}
...
![The letter 'e' made from a circle (it looks bad)](font_4.png){: style="max-width: 400px"}
